...
>传统方式下我们可能把学校、学院和系设计成继承关系，这样是站在组织大小的角度上划分的。但是这样不能很好地实现管理操作，比如对一个学校增加学院。
...
>Map接口相当于Component，他对子节点的管理方法是没有实现的

![#1](../../../../img/pattern/sp/composite/Snipaste_2021-02-24_17-24-36.png)

>而AbstractMap对于管理子节点的方法提供了默认实现，也相当于Component

![#2](../../../../img/pattern/sp/composite/Snipaste_2021-02-24_17-25-18.png)

>HashMap则相当于Composite，它对管理子节点的方法进行了实现

![#3](../../../../img/pattern/sp/composite/Snipaste_2021-02-24_17-26-24.png)

>HashMap中的Node相当于Leaf，它没有子节点，也无法操作子节点

![#4](../../../../img/pattern/sp/composite/Snipaste_2021-02-24_17-29-27.png)

#### 优缺点

* ###### 可以简化客户端操作，有较强的扩展性，对于具有树形结构的对象比较适合

* ###### 要求较高的抽象性，如果节点和叶子差异较大时，则不适合使用组合模式

* ###### 叶子和非叶子节点的声明都是实现类，违背了依赖倒置原则
